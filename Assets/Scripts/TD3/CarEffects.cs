...
public class CarEffects : MonoBehaviour
{
    ...
    private void UpdateTurnWheelsEffect()
    {
        ...
        Debug.Log("Updated wheel effect !");

        leftWheel.localRotation = Quaternion.Euler(leftWheel.localRotation.eulerAngles.x, 90 + carMovement.input.x * 60f, leftWheel.localRotation.eulerAngles.z);
        rightWheel.localRotation = Quaternion.Euler(rightWheel.localRotation.eulerAngles.x, 90 + carMovement.input.x * 60f, rightWheel.localRotation.eulerAngles.z);
    }
