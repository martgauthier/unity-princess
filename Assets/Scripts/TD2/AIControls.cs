...
public class AIControls : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Transform[] transformPlusAllChildren=waypointsHolder.GetComponentsInChildren<Transform>();
        waypoints.AddRange(transformPlusAllChildren.Skip(1));//skip the first element, as it is the parent transform
        Debug.Log(waypoints);
    }
    ...
    void SelectWaypoint(Transform waypoint)
    {
        ...
        nextWaypointPosition = nextWaypoint.position + new Vector3(UnityEngine.Random.Range(-randomJitterOnPosition, randomJitterOnPosition), 0, UnityEngine.Random.Range(-randomJitterOnPosition, randomJitterOnPosition));
    }
}
